...
const InterleavingFrames = () => {
  ...
  return (
    <div ref={containerRef} className={`relative w-full flex flex-col ${ isFullscreen ? 'h-screen bg-black' : 'h-full' }`}>
      <div className={`flex justify-center items-center w-full ${isFullscreen ? 'h-[calc(100vh-50px)]' : 'h-full'}`}>
        <video
          ref={videoRef}
